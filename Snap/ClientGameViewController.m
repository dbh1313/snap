...
@interface ClientGameViewController ()
...
@implementation ClientGameViewController {
...
{
	[self.delegate ClientGameViewController:self didQuitWithReason:reason];
}
